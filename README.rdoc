...
Tests need searchd service with "test1" index. Checkout src/test/resources/sphinx_test.sql  and  src/test/resources/sphinx/sphinx.conf files to build index.
