...
Tests need searchd service with "test1" index. Checkout <tt>src/test/resources/sphinx_test.sql</tt> and <tt>src/test/resources/sphinx/sphinx.conf</tt> files to build index.
